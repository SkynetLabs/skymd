  ...
  <div>
    <b-navbar toggleable="sm" type="dark" variant="primary">
      ...
      <b-collapse id="nav-text-collapse" is-nav>
        <b-navbar-nav @click="Save(data)">
          <b-nav-item><b-icon icon="cloud-upload"></b-icon> Save</b-nav-item>
        </b-navbar-nav>
      </b-collapse>
    ...
    <br />
    <notebook v-if="this.mounted" v-show="this.ready" v-model="data" @ready="Ready()"></notebook>
